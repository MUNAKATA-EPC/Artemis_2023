...
threshold_for_court = (73, 92, -75, -34, 20, 55) # コートの色取り用変数
threshold_for_goal = (79, 100, -21, 127, 46, 127) # ゴールの色取り用変数(黄色)
...
while(True):
    ...
    port2.pulse_width_percent(int(goal_deg))
